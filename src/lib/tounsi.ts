...
export const barberProfile = {
  fr: {
    ...
    categories: ["Populaire", "Coupes", "Barbe", "Soins"],
    removeServiceAria: "Retirer service",
    addServiceAria: "Ajouter service",
    ...
    servicesSelected: (n: number) =>
      `${n} service${n > 1 ? "s" : ""} sélectionné${n > 1 ? "s" : ""}`,
  ...
  tn: {
    ...
    servicesTitle: "Services",
    categories: ["Populaire", "9assat", "Le7ya", "Etina"],
    removeServiceAria: "Na7i service",
    addServiceAria: "Zid service",
    ...
    servicesSelected: (n: number) => `${n} service mekhtar${n > 1 ? "in" : ""}`,
    bookingInProgress: "Rzervation...",
    bookNow: "Rzervi tawa",
    yourBooking: "Rzervation mte3ek",
    total: "Total",
