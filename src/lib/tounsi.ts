...
export const home = {
  fr: {
    ...
    headlineMobile: "Le bon barbier, au bon moment.",
    headlineDesktop1: "Le bon barbier,",
    headlineDesktop2: " au bon moment.",
    subtitle:
...
export const dashboard = {
  ...
  tn: {
    ...
    requestsTitle: "RDV bech t9ebelhom",
    agendaTitle: "Agenda",
    noRequests: "Ma fama 7ata talab fil intidhar.",
    ...
    seeAll: "Chouf kol",
    confirmed: "Mou2akad",
    toConfirm: "Yestanna ta2kid",
    bookingsTitle: "Rendez-vous",
    pending: "Fil intidhar",
    accept: "E9bel",
    decline: "Orfodh",
    done: "Kamel",
    cancelled: "Mefsou5 / Marfoudh",
    ...
    sunday: "El Ahad",
    days: ["Ethnin", "Thletha", "Erbaa", "5mis", "Jom3a", "Sebt", "El Ahad"],
    closed: "Ma8lou9",
    contact: "Contact",
    phoneLabel: "Téléphone",
    emailLabel: "E-mail",
...
export const editProfileDialog = {
  ...
  tn: {
    ...
    phone: "Téléphone",
    email: "E-mail",
    hoursTitle: "Wa9t el khedma b nhar",
    open: "Ma7loul",
    closed: "Ma8lou9",
    days: ["Ethnin", "Thletha", "Erbaa", "5mis", "Jom3a", "Sebt", "El Ahad"],
    cancel: "Batel",
...
export const search = {
  ...
  tn: {
    ...
    resultsTitleNear: "Hajjam 9rib menek",
    resultsTitleIn: (gov: string) => `Hajjam fi ${gov}`,
...
export const barberProfile = {
  ...
  tn: {
    ...
    loginPromptText: "Connecti bech trzervi fel wa9t elli ynesbek, fi thawani.",
...
export const clientAccount = {
  ...
  tn: {
    ...
    backAria: "Erj3a",
    phoneLabel: "Téléphone",
    noPhone: "Ma famach numéro",
    memberSince: (date: string) => `Membre men ${date}`,
    logout: "Khrouj",
    navHome: "Accueil",
    navExplore: "Lawej",
    navBookings: "RDV",
