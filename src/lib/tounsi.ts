...
export const barberProfile = {
  ...
  tn: {
    ...
    dayOffWarning: "El barbier ma5damch fel nhar hedha. Ekhtar nhar okhor.",
    ...
    servicesSelected: (n: number) => `${n} service metkhtar${n > 1 ? "in" : ""}`,
    bookingInProgress: "Rzervation...",
    bookNow: "Rzervi tawa",
    yourBooking: "Rzervation mte3ek",
    total: "Total",
    confirmTitle: "Confirmi rzervation",
    confirmDescription: "Chouf details 9bal ma tabaath talab lel barbier.",
    confirmDateTime: "Date w wa9t",
    cancel: "Batel",
    confirm: "Confirmi",
    sentTitle: "Talab tba3eth lel barbier",
    sentDescription: (when: string) =>
      `Maw3dek talab lel ${when}. Fil intidhar el confirmation mta3 el barbier.`,
    ok: "OK",
  },
} as const satisfies Record<Lang, unknown>;
